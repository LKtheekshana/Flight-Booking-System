...
public class SignedFlight extends javax.swing.JFrame {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
            PreparedStatement ps = conn.prepareStatement("insert into flights(Type, AgeGroup, Class, FromThis, ToThis, Date, UserName) values (?,?,?,?,?,?,?)");
            ps.setString(1, (String) cmbTrip.getSelectedItem());
            ps.setString(2, (String) cmbPerson.getSelectedItem());
            ps.setString(3, (String) cmbClass.getSelectedItem());
            ps.setString(4, txtFrom1.getText());
            ps.setString(5, txtTo.getText());
            
            Date date = DtFlight.getDate();
