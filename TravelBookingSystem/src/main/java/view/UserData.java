...
public class UserData extends javax.swing.JFrame {
    ...
    public UserData() {
        ...
        try {
            PreparedStatement ps = conn.prepareStatement("-- LEFT JOIN\n"
                    + "SELECT flights.Type, flights.AgeGroup, flights.Class, flights.FromThis, flights.ToThis, flights.Date, hotel.Location, hotel.Date, hotel.Type\n"
                    + "FROM flights\n"
                    + "LEFT JOIN hotel ON flights.UserName = hotel.UserName\n"
                    + "\n"
                    + "UNION\n"
                    + "\n"
                    + "-- RIGHT JOIN (including only the rows not already included by LEFT JOIN)\n"
                    + "SELECT flights.Type, flights.AgeGroup, flights.Class, flights.FromThis, flights.ToThis, flights.Date, hotel.Location, hotel.Date, hotel.Type\n"
                    + "FROM hotel\n"
                    + "LEFT JOIN flights ON flights.UserName = hotel.UserName\n"
                    + "WHERE flights.UserName IS NULL;");
    ...
    private void initComponents() {
        ...
        txtHPerson = new javax.swing.JTextField();
        ...
        txtUPFormTripType = new javax.swing.JTextField();
        ...
        txtUPFormClass = new javax.swing.JTextField();
        txtUPFormPersonType = new javax.swing.JTextField();
            ...
            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtHPerson, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtUPFormClass, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtUPFormPersonType, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtUPFormTripType, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtUPFormTripType, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtUPFormPersonType, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(5, 5, 5)
                        .addComponent(lblHotelDetails)
                        .addGap(17, 17, 17)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(8, 8, 8)
                                        .addComponent(txtHPerson, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(lblUPForm)))
                                .addGap(19, 19, 19)
                ...
                .addGap(13, 13, 13)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtUPFormClass, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblUPFormClass))
    ...
    private void btnRXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRXActionPerformed
        ...
        FormBooking fm = new FormBooking();
        fm.setVisible(true);
    ...
    private javax.swing.JTextField txtHPerson;
    private javax.swing.JTextField txtPlace;
    private javax.swing.JTextField txtUPFormClass;
    private javax.swing.JTextField txtUPFormPersonType;
    private javax.swing.JTextField txtUPFormTripType;
